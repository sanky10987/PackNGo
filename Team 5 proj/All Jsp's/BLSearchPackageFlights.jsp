...
<jsp:setProperty name="FBean" property="source1" value="<%=session.getAttribute("sourceS").toString() %>" />
<jsp:getProperty name="FBean" property="source1"/>
<jsp:setProperty name="FBean" property="dest1" value="<%=session.getAttribute("destinationD").toString() %>" />
<jsp:getProperty name="FBean" property="dest1"/>
<jsp:setProperty name="FBean" property="depdate1" value="<%=session.getAttribute("packageDate").toString()%>" />
<jsp:setProperty name="FBean" property="adate1" value="<%=session.getAttribute("arrivalDate").toString() %>" />
<jsp:setProperty name="FBean" property="numadult1" value="<%=Integer.parseInt(session.getAttribute("numAS").toString()) %>" />
<jsp:setProperty name="FBean" property="numchild1" value="<%=Integer.parseInt(session.getAttribute("numCS").toString()) %>" />
...
<%
	...
	//out.print(limit);
%>
<form method="post" action="BookPackageFlight.jsp">
