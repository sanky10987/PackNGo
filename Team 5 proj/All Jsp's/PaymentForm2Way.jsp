...
<form name="payment" action="PF2CheckValidCard.jsp" method="post">
<table border="2" cellpadding="5" cellspacing="3" BORDERCOLOR="#151B54">
<thead><h2><b>Your  Bill</b></h2></thead>
<tr>
...
<tr>
<td><b>Total Amount</b></td><td><input type="text" name="total" value="<%=session.getAttribute("total")%>" readonly></td>
</tr>
<tr>
