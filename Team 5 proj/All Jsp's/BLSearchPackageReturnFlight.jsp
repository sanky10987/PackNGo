...
<jsp:setProperty name="FBean" property="source1" value="<%=session.getAttribute("destinationD") %>" />
<jsp:setProperty name="FBean" property="dest1" value="<%=session.getAttribute("sourceS") %>" />
<jsp:setProperty name="FBean" property="depdate1" value="<%=session.getAttribute("arrivalDate") %>" />
...
<%
	...
	//out.print(limit);
%>
<form method="post" action="BookPackageReturnFlight.jsp">
